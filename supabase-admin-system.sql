...
ALTER TABLE user_spots ADD COLUMN IF NOT EXISTS approved_by TEXT REFERENCES profiles(id);
...
BEGIN
  ...
  VALUES (admin_id, 'approve_spot', spot_id, 'community_spot', '{"action": "approved"}');
...
BEGIN
  ...
  -- Log the admin action
  INSERT INTO admin_actions (admin_id, action_type, target_id, target_type, details)
  VALUES (admin_id, 'reject_spot', spot_id, 'community_spot', 
